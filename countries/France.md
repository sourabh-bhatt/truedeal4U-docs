...
- **Passport**:
  - Requires physical.
  - Passport should be valid for at least 6 months from the date of departure from France.
...
- **Minor Travelling with One Parent**:
  ...
  - All minors must be accompanied by both parents or legal guardians and sign the application form in front of a VFS officer, except when the child is visiting the other parent residing in France.
...
- **Staying with friends and family**:
  - Original Invitation letter (townhall letter) in the French language with the signatures of the Inviting person or family, issued and endorsed by the France Office of Immigration and Nationality or certified by a public notary.
...
- **Sponsor documents**:
  ...
  - Government ID proof (Passport, Driving license, PAN card) of the sponsor if the sponsor is from India (or) If the sponsor is from France, then passport/driving license copy of the sponsor.
