...
- **Passport**:
  ...
  - Should be valid for at least 6 months from the date of departure from Hungary.
...
- **Minor Travelling with One Parent**:
  ...
  - All minors must be accompanied by both parents or legal guardians and sign the application form in front of a VFS officer, except when the child is visiting the other parent residing in Hungary.
...
- **Staying with Friends and Family**:
  - Original Invitation letter (townhall letter) in Hungarian language with the signatures of the Inviting person or family, issued and endorsed by the Hungarian Office of Immigration and Nationality or certified by a public notary.
...
- **Sponsor Documents**:
  ...
  - Government ID proof (Passport, Driving license, PAN card) of the sponsor if the sponsor is from India (or) If the sponsor is from Hungary, then passport/driving license copy of the sponsor.
  
- **Internal Travel**:
  - If the applicant is traveling internally within the Schengen area, the applicant has to submit internal commute proof.
  
- **Marriage Certificate**:
  - Applicable if the spouse's name is not mentioned at the back of the passport. (Apostilled for Mumbai Jurisdiction Case).
